...
// Structure matches your original, but 'visuals' and 'desc' are tuned for the AI prompt.
const RACES = {
  "Sethite": {
    ...
    // CULTURAL VISUALS: Ancient Levantine Priesthood / Semitic Patriarchs
  ...
  "Cainite": {
    ...
    // CULTURAL VISUALS: Ancient Babylonian / Sumerian Nobility
  ...
  "Wanderer": {
    ...
    // CULTURAL VISUALS: Proto-Bedouin / Desert Nomads
  ...
  "Nephilim": {
    ...
    // CULTURAL VISUALS: Bronze Age Demigods (Not medieval demons)
  ...
  "Anakim": {
    ...
    // CULTURAL VISUALS: Philistine / Canaanite Warlords
...
const CLASSES = [
  "Warrior", "Priest", "Hunter", "Artisan", "Sorcerer"
];
...
const CharacterGenerator = () => {
  ...
  const handleStatChange = (stat, delta) => {
    const getPointCost = (s) => (s <= 13 ? s - 8 : s === 14 ? 7 : 9);
  ...
  // --- UPDATED AI LOGIC (Drop-in Replacement) ---
  ...
  return (
    <div className="min-h-screen bg-[#0c0c0c] text-[#e0e0e0] font-sans pb-20">
      ...
      <div className="max-w-4xl mx-auto p-4 md:p-6">
        ...
        {step === 1 && (
          <div className="space-y-8 animate-fade-in">
            {/* Race Selection - Original Layout */}
            <section>
              <h2 className="font-cinzel text-[#d4af37] text-xl mb-4">I. LINEAGE</h2>
                  ...
                  <button
                    ...
                    className={`text-left p-4 border transition-all duration-300 relative overflow-hidden ${
                      selectedRace === key 
                        ...
                        : 'border-[#333] hover:border-[#666] bg-white/5'
                    }`}
                  >
                    <div className="font-bold text-lg mb-1 text-[#d4af37]">{RACES[key].name}</div>
                    <div className="text-xs text-[#888] mb-2">{RACES[key].desc}</div>
                    <div className="flex flex-wrap gap-1">
                        {Object.entries(RACES[key].stats).map(([stat, val]) => (
                            <span key={stat} className="text-[10px] uppercase bg-black/40 px-1.5 py-0.5 rounded border border-[#333] text-[#8a7018]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <section>
                <h2 className="font-cinzel text-[#d4af37] text-xl mb-4">II. CALLING</h2>
                <select 
                  className="w-full bg-[#1a1a1a] border border-[#333] p-3 text-[#e0e0e0] focus:border-[#d4af37] focus:outline-none"
                  value={selectedClass}
              ...
              <section>
                <h2 className="font-cinzel text-[#d4af37] text-xl mb-4">III. ORIGIN</h2>
                <select 
                    className="w-full bg-[#1a1a1a] border border-[#333] p-3 text-[#e0e0e0] focus:border-[#d4af37] focus:outline-none"
            ...
            <section>
                 <h2 className="font-cinzel text-[#d4af37] text-xl mb-4">IV. ALIGNMENT</h2>
            ...
            <div className="flex justify-end pt-4">
              <button 
                onClick={() => setStep(2)}
                className="bg-[#d4af37] text-black font-bold px-8 py-3 hover:bg-[#b5952f] transition-colors font-cinzel"
              >
                NEXT STEP
              </button>
            </div>
          ...
          <div className="space-y-8 animate-fade-in">
             <div className="flex justify-between items-end border-b border-[#333] pb-4">
                ...
                <div className="text-right">
                    <div className="text-xs text-[#888] uppercase tracking-widest">Points</div>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {Object.keys(baseStats).map(stat => {
                    ...
                    return (
                        <div key={stat} className="bg-white/5 border border-[#333] p-4 relative group hover:border-[#555]">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-[#8a7018] font-bold uppercase tracking-wider">{stat}</span>
                            ...
                            <div className="flex items-center justify-between mb-3">
                                <button 
                                    ...
                                    className="w-8 h-8 flex items-center justify-center border border-[#444] text-[#888] hover:bg-black hover:text-white"
                                >-</button>
                            ...
                            <div className="flex justify-between items-center text-xs border-t border-dashed border-[#333] pt-2">
                                <span className="text-[#666]">
                                    {racialBonus > 0 ? `+${racialBonus} Racial` : '-'}
                                </span>
                                <span className="bg-[#1a1a25] border border-[#8a7018] text-[#f9e29c] px-2 py-0.5 text-xs rounded">
                                    {mod}
                                </span>
                            </div>
                        </div>
             ...
             <div className="flex justify-between pt-8">
                ...
                <button 
                    ...
                    className="bg-[#d4af37] text-black font-bold px-8 py-3 hover:bg-[#b5952f] disabled:opacity-50 transition-all font-cinzel flex items-center gap-2"
                >
                    {isGenerating ? "SCRIBING..." : "GENERATE"}
                </button>
             </div>
             ...
             <div className="bg-[#141414] border border-[#d4af37] p-1 relative overflow-hidden">
                <div className="bg-[#0c0c0c] p-6 md:p-10 relative">
                    <div className="text-center mb-8">
                        ...
                        <div className="text-[#888] text-sm uppercase tracking-[0.2em]">{selectedAlignment} {raceData.name.split('(')[0]} {selectedClass}</div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        <div className="bg-white/5 p-4 border border-[#333]">
                            <h3 className="text-[#d4af37] font-cinzel mb-2 border-b border-dashed border-[#333] pb-1">Appearance</h3>
                            <p className="text-sm text-[#ccc] leading-relaxed italic">
                                "{generatedLore.appearance}"
                            </p>
                        </div>
                        <div className="bg-white/5 p-4 border border-[#333]">
                            <h3 className="text-[#d4af37] font-cinzel mb-2 border-b border-dashed border-[#333] pb-1">Backstory</h3>
                    ...
                    <div className="grid grid-cols-6 gap-2 mb-8">
                         {Object.keys(finalStats).map(stat => (
                             <div key={stat} className="text-center border border-[#333] p-2 bg-white/5">
                                 <div className="text-[10px] text-[#8a7018] uppercase">{stat}</div>
