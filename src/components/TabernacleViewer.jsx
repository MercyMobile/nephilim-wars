...
const TabernacleViewer = () => {
  ...
  const TabernacleVisual = () => (
   // Line 24 correction:
<div className="relative w-full h-[450px] bg-[#0a0a0a] rounded-xl overflow-hidden border border-amber-900/50 shadow-2xl flex items-center justify-center mt-4">
